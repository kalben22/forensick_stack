...
class Artifact(Base):
    ...
    file_path = Column(String(500))  # Path dans MinIO
...
class Analysis(Base):
    ...
    module_name = Column(String(100))  # volatility, plaso, regripper
    status = Column(String(50), default="pending")  # pending, running, completed, failed
    started_at = Column(DateTime)
    completed_at = Column(DateTime)
    result_path = Column(String(500))  # Path vers résultats
